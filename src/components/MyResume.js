...
const MyResume = (props) => {
  return (
    ...
    <div style={{ maxWidth: '1100px', marginLeft: '150px', marginRight: '150px', backgroundColor: 'white', color: 'black' }} className='resume-page App animate__animated animate__fadeIn'>
      <Col style={{ paddingTop: '20px', paddingBottom: '20px' }} sm={9}><span style={{ fontSize: '30px' }}>Tracy Falba, Ph.D.</span>
        ...
        <ListGroup>
          <ListGroup.Item className='resume-list-item'>Served as department liaison in partnership with University IT and outside vendor to overhaul the department CMS.. Our site became the 'in-demand' template across Arts and Sciences.</ListGroup.Item>
          <ListGroup.Item className='resume-list-item'>Developed social media channels and engaged faculty, staff, and student participation, receiving over 50K YouTube views in our first year.</ListGroup.Item>
        </ListGroup>
        <Row className='resume-title'>Associate Director of Undergraduate Studies (2009 - 2017)</Row>
        <ListGroup>
          <ListGroup.Item className='resume-list-item'>Led Undergraduate Research Symposia and Honors Thesis Poster Sessions, united the Arts and Science honors office with numerous graduate students and department faculty.</ListGroup.Item>
          <ListGroup.Item className='resume-list-item'>Supervised program staff and advised undergrads. Implemented online surveys within department to evaluate curriculum effectiveness significantly improving student outcomes and satisfaction.</ListGroup.Item>
        </ListGroup>
        <Row className='resume-title'>Visiting Assistant Professor and Research Scholar (2006 - 2017)</Row>
        <ListGroup>
          <ListGroup.Item className='resume-list-item'>Designed and taught courses in Health Economics, Public Economics, Economics of Social Insurance, and other Special Topics and Workshop Courses.</ListGroup.Item>
        </ListGroup>
        ...
        <ListGroup>
          <ListGroup.Item className='resume-list-item'>Co-investigator on grants totaling over $10 million</ListGroup.Item>
          <ListGroup.Item className='resume-list-item'>Engaged in interdisciplinary research and collaborative projects resulting In twenty scholarly articles published in health policy, economics, and medical journals.</ListGroup.Item>
        </ListGroup>
        <Row className='resume-title'>Co-Direcor of Communications for Transdisciplinary Tobacco Use Research Center</Row>
        <ListGroup>
          <ListGroup.Item className='resume-list-item'>Created faculty awareness and participation in using platforms to communicate significant research findings.</ListGroup.Item>
          <ListGroup.Item className='resume-list-item'>Generated over 20 feature articles on the center's research picked up by national news media.</ListGroup.Item>
        </ListGroup>
      </Col>
